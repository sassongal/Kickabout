                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Opacity(
                                            opacity:
                                                hubPermissions.canManageSettings
                                                    ? 1.0
                                                    : 0.5,
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildGameCard(
                          ...
                          game: primaryGame,
                          eventId: eventId,
                          matchCount: primaryGame.matches.length,
        ...
        child: Column(
          ...
          children: [
            ...
            if (game.aggregateWins.isNotEmpty) ...[
              ...
              ...game.teams.map((team) {
                final wins = game.aggregateWins[team.color ?? team.name] ?? 0;
                return Container(
            ...
            if (matchCount > 0)
              if (!isCollapsed)
                ExpansionTile(
                  ...
                  children: game.matches.map((match) {
                    return ListTile(
                      dense: true,
