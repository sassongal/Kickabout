...
abstract class $VenueCopyWith<$Res> {
  ...
  $Res call(
      ...
      String name,
      String? description,
      @GeographicPointFirestoreConverter() GeographicPoint location,
      String? address,
      String? city,
      String? region,
...
class _$VenueImpl implements _Venue {
  const _$VenueImpl(
      ...
      required this.name,
      this.description,
      @GeographicPointFirestoreConverter() required this.location,
      this.address,
      this.city,
      this.region,
      this.googlePlaceId,
...
abstract class _Venue implements Venue {
  const factory _Venue(
      ...
      final String? description,
      @GeographicPointFirestoreConverter()
      required final GeographicPoint location,
      final String? address,
      final String? city,
      final String? region,
      final String? googlePlaceId,
  ...
  @override
  @GeographicPointFirestoreConverter()
  GeographicPoint get location; // Exact location from Google Maps
  @override
