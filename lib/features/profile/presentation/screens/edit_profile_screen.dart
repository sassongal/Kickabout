              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'גובה (ס״מ)',
                    hintText: '175',
                    helperText: 'נתונים אלו משפרים את איזון הכוחות במשחקים',
                    border: OutlineInputBorder(),
                  ...
                  validator: (value) {
                    ...
                    if (height == null) return 'ערך לא תקין';
                    if (height < 140 || height > 220) return 'גובה לא סביר (140-220 ס״מ)';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'משקל (ק״ג)',
                    hintText: '72',
                    helperText: 'משפר את יצירת הכוחות המאוזנים',
                    border: OutlineInputBorder(),
                  ...
                  validator: (value) {
                    ...
                    if (weight == null) return 'ערך לא תקין';
                    if (weight < 40 || weight > 150) return 'משקל לא סביר (40-150 ק״ג)';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
