...
import 'package:kattrick/features/games/domain/models/game_result.dart';
...
class GameFinalizationService {
  ...
  Future<void> finalizeGame(String gameId, GameResult result) async {
    ...
    // Get game data to extract hubId and playerIds for the event
    ...
    if (_eventBus != null && game.hubId != null) {
      ...
      debugPrint('🔔 GameFinalizedEvent fired: $gameId');
    }
  }
}
