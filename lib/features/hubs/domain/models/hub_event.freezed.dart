...
mixin _$HubEvent {
  ...
  GeographicPoint? get locationPoint => throw _privateConstructorUsedError;
...
// Reference to Game if event was converted to game
  String? get gameId =>
      throw _privateConstructorUsedError; // If event was converted to game, reference it
// Event completion data (set when event is finished)
  @TimestampConverter()
  DateTime? get completedAt =>
      throw _privateConstructorUsedError; // When event was marked as completed
  String? get winningTeamColor =>
      throw _privateConstructorUsedError; // Team color with most wins
  String? get eventMvpId =>
      throw _privateConstructorUsedError; // Player ID who was MVP most times
...
abstract class $HubEventCopyWith<$Res> {
  ...
  $GeographicPointCopyWith<$Res>? get locationPoint;
}
...
class _$HubEventCopyWithImpl<$Res, $Val extends HubEvent>
  ...
  $GeographicPointCopyWith<$Res>? get locationPoint {
    ...
    return $GeographicPointCopyWith<$Res>(_value.locationPoint!, (value) {
...
class _$HubEventImpl implements _HubEvent {
  const _$HubEventImpl(
      ...
      this.location,
      @NullableGeographicPointFirestoreConverter() this.locationPoint,
      this.geohash,
      this.venueId,
      this.teamCount = 3,
      this.gameType,
...
// Reference to Game if event was converted to game
  @override
  final String? gameId;
// If event was converted to game, reference it
// Event completion data (set when event is finished)
  @override
  @TimestampConverter()
  final DateTime? completedAt;
// When event was marked as completed
  @override
  final String? winningTeamColor;
// Team color with most wins
  @override
  final String? eventMvpId;
// Player ID who was MVP most times
  @override
  @JsonKey()
...
abstract class _HubEvent implements HubEvent {
  const factory _HubEvent(
      ...
      final String? winningTeamColor,
      final String? eventMvpId,
      final int totalMatches}) = _$HubEventImpl;
...
// Reference to Game if event was converted to game
  @override
  String? get gameId; // If event was converted to game, reference it
// Event completion data (set when event is finished)
  @override
  @TimestampConverter()
  DateTime? get completedAt; // When event was marked as completed
  @override
  String? get winningTeamColor; // Team color with most wins
  @override
  String? get eventMvpId; // Player ID who was MVP most times
  @override
