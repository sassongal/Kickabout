...
// Format: {'canCreateEvents': ['userId1', 'userId2']}
  ...
  @NullableGeographicPointFirestoreConverter()
  GeographicPoint? get primaryVenueLocation =>
...
abstract class $HubCopyWith<$Res> {
  ...
  $Res call(
      ...
      @NullableGeographicPointFirestoreConverter()
      GeographicPoint? primaryVenueLocation,
  ...
  $GeographicPointCopyWith<$Res>? get primaryVenueLocation;
}
...
class _$HubCopyWithImpl<$Res, $Val extends Hub> implements $HubCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  $GeographicPointCopyWith<$Res>? get primaryVenueLocation {
    if (_value.primaryVenueLocation == null) {
      return null;
    }

    return $GeographicPointCopyWith<$Res>(_value.primaryVenueLocation!,
        (value) {
      return _then(_value.copyWith(primaryVenueLocation: value) as $Val);
    });
  }
}
...
class _$HubImpl extends _Hub {
  const _$HubImpl(
      ...
      this.mainVenueId,
      this.primaryVenueId,
      @NullableGeographicPointFirestoreConverter() this.primaryVenueLocation,
...
// ID of the primary venue (for map display) - denormalized
  @override
  @NullableGeographicPointFirestoreConverter()
  final GeographicPoint? primaryVenueLocation;
...
// Format: {'canCreateEvents': ['userId1', 'userId2']}
  ...
  @override
  @NullableGeographicPointFirestoreConverter()
  GeographicPoint? get location; // Primary location (deprecated, use venues)
  @override
  String? get geohash;
  @override
