...
class HubEvent with _$HubEvent {
  const factory HubEvent({
    ...
    String? location,
    @NullableGeographicPointFirestoreConverter() GeographicPoint? locationPoint,
    String? geohash,
    ...
    @TimestampConverter() DateTime? completedAt, // When event was marked as completed
    String? winningTeamColor, // Team color with most wins
    String? eventMvpId, // Player ID who was MVP most times
    @Default(0) int totalMatches, // Total number of matches played
  }) = _HubEvent;
