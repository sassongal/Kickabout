...
_$FeedPostImpl _$$FeedPostImplFromJson(Map<String, dynamic> json) =>
    _$FeedPostImpl(
      ...
      winningTeamColor: json['winningTeamColor'] as String?,
      winningTeamWins: (json['winningTeamWins'] as num?)?.toInt(),
      eventMvpId: json['eventMvpId'] as String?,
      eventMvpName: json['eventMvpName'] as String?,
...
Map<String, dynamic> _$$FeedPostImplToJson(_$FeedPostImpl instance) =>
    <String, dynamic>{
      ...
      'city': instance.city,
      'winningTeamColor': instance.winningTeamColor,
      'winningTeamWins': instance.winningTeamWins,
      'eventMvpId': instance.eventMvpId,
      'eventMvpName': instance.eventMvpName,
